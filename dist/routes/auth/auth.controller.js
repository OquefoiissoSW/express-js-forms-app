 ...
 *               }
 */
router.get('/users/:userId', auth_service_1.getUser);
/**
 * @swagger
 * components:
 *   schemas:
 ...
 *
 */
router.post('/users', auth_service_1.createUser);
/**
 * @swagger
 * /api/users/login:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/users/login', auth_service_1.login);
/**
 * @openapi
 * /api/protected:
 *  get:
...
*/
router.get('/protected', auth_1.authenticateJWT, (req, res) => {
